...
Three different example datasets were generated, named [Hackathon_Data1](dataset/Hackathon_Data1.csv), [Hackathon_Data3](dataset/Hackathon_Data3.csv), and [Hackathon_Data4](dataset/Hackathon_Data4.csv).

Their variables are described in the [Codebook](dataset/CODEBOOK.md) and the overall content is summarized in the [README](dataset/README.md).
